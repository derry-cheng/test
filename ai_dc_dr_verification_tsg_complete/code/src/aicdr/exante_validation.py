...
def run_exp25_exante_job_validation(
    ...
    submission = load_mit_submission_ledger(
        ...
        declared_fraction_model=calibration.get("per_job_fraction_model"),
    ...
    by_type = (
        ...
        .agg(
            jobs=("id_job", "size"),
            declared_fraction_q10=("declared_service_fraction_q10", "median"),
            declared_fraction_q50=("declared_service_fraction_q50", "median"),
            declared_fraction_q90=("declared_service_fraction_q90", "median"),
    ...
    write_metadata = {
        ...
        "declared_service_fraction": float(calibration["declared_service_fraction"]),
        "declared_fraction_source": submission.attrs.get(
            "declared_fraction_source", "unknown"
        ),
        "declared_fraction_model_version": submission.attrs.get(
            "declared_fraction_model_version", "unknown"
        ),
        "conditional_fraction_model": calibration.get("per_job_fraction_model", {}),
