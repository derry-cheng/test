...
from .contract_lineage import run_exp30_contract_lineage_audit
...
def run_pipeline(
    ...
    functions: list[tuple[str, Callable[[], None]]] = [
        ...
        ("exp30", lambda: run_exp30_contract_lineage_audit(root, cfg, logger)),
    ...
    if resume_all_run:
        ...
        for name in {"exp2", "exp9", "exp10", "exp11", "exp12", "exp15", "exp17", "exp18", "exp19", "exp20", "exp21", "exp22", "exp23", "exp24", "exp26", "exp27", "exp28", "exp29", "exp30", "audit"}:
    ...
    if stage in {
        ...
        "exp26",
        "audit",
    } and stage not in {"audit", "exp2", "exp9", "exp10", "exp11", "exp12", "exp17", "exp18", "exp20", "exp21", "exp22", "exp23", "exp24", "exp27", "exp28", "exp29", "exp30", "exp26"}:
        preprocess_all(root, cfg, False, logger)
    elif stage in {"audit", "exp2", "exp9", "exp10", "exp11", "exp12", "exp17", "exp18", "exp20", "exp21", "exp22", "exp23", "exp24", "exp27", "exp28", "exp29", "exp30", "exp26"}:
        ...
        # because it scores the locked tensor and locked upstream profiles only. Explicit
