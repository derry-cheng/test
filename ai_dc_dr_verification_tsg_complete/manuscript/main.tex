...
remain locked for evaluation. The complete-ledger verifier obtains normalized
root-mean-square error (nRMSE)
0.343 with 1.717 MWh/day of unsupported gross credit. At a gate one
hour before the event, the committed-ledger operating replay has nRMSE
0.358, 3.442 MWh/day of gross false credit, and 7.015 MWh/day of
meter-capped payable credit (recall 0.292, F1=0.283); the submitted baseline is frozen before
the event.
An independent job-indexed
linear program covers all 71,128
positive-energy jobs with 5,465,157 admissible job--slot variables and yields a
net event reduction of 0.167 MWh (gross reduction 0.183 MWh and rebound
0.016 MWh), with a maximum job-energy residual of
$2.17\times10^{-19}$ MWh. A homogeneous scale-consistency certificate reaches
the committed 118-MW nameplate at a capacity-proportional 3475.108$\times$
scale while preserving every job-level equality and admissible window; with
the fixed 0.001-MW/GPU nameplate held constant, the certified scale is
1.036$\times$. The security panel evaluates all 37 finite IEEE
Reliability Test System 24-bus (RTS-24) line outages and the spatial panel evaluates four public networks, 24 regional
...
separately optimized post-contingency active schedules. The implementation
...
0.343. This is selective risk control, not uniform predictive dominance.
...
and locked days; the fairness audit records equation-level controls rather than
software reimplementations \cite{chen2021incentive,cao2022flexibility}. The
