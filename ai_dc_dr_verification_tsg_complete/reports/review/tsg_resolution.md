...
all four metrics over the single feasible projection and weakly dominating every
declared declaration-causal workload-feasible baseline row. A new seven-profile
causal-hull certificate scores every vertex with the locked metric definitions,
records pairwise dominance, and marks the selected vertex Pareto-efficient; this
keeps the table-level dominance claim distinct from the internal accuracy--risk
frontier.
...
same-directory atomic replacement. The final unified audit reports 392/392
