...
- `exp26_end_to_end_certificate`: cached end-to-end lineage certificate that
  rechecks the indexed witness, role-separated risk/payment artifacts, and the
  frozen outage replay.
